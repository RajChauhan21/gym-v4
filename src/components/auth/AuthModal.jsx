  ...
  return (
    ...
    >
      <DialogTrigger asChild>
        <Button
          size="lg"
          className="rounded-full shadow-lg bg-white text-black cursor-pointer"
        >
          {triggerText}
        </Button>
      </DialogTrigger>
      ...
      <DialogContent
        className="w-[92%] max-w-4xl p-0 overflow-hidden border-none bg-transparent rounded-3xl"
