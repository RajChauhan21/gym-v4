  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-xl cursor-pointer"
        >
      ...
      <DialogContent
        className="w-[95%] sm:max-w-[400px] rounded-2xl bg-white dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 p-0 overflow-hidden shadow-2xl"
        ...
        <div className="p-6">
          <DialogHeader className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2 leading-relaxed">
              This will end your active sessions on all other devices. You will
              need to log back in to use the gym portal elsewhere.
            </p>
          </DialogHeader>
        </div>
