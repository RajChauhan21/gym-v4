    ...
    try {
      ...
      if (response.data.statusCodeValue === 200) {
        ...
        const updatedProfile = {
          ...
          ownerLogo:
            userData.ownerImage ||
            "https://png.pngtree.com/png-vector/20230801/ourmid/pngtree-cartoon-superhero-with-red-cape-with-logo-on-white-background-vector-png-image_6830646.png",
          googleMapUrl:
            userData.googleMapUrl || "https://maps.google.com/?q=paramount+gym",
        ...
        navigate("/dashboard");
      } else if (response.data.statusCodeValue === 404 || response.status === 404) {
        toast.error(
          "Something went wrong while fetching plans. Please try again later.",
        );
      } else if (response.data.statusCodeValue === 429 || response.status === 429) {
        toast.error(
